...
async def test_daily_bars_from_csv(filename, backtesting_dispatcher):
    bars = []
    events = []
...
async def test_daily_bars_from_utf_16_csv(backtesting_dispatcher):
    bars = []
    events = []
...
async def test_minute_bars_from_csv_using_deprecated_period_format(backtesting_dispatcher):
    bars = []
