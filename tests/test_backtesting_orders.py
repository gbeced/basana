...
from basana.backtesting.orders import OrderOperation, MarketOrder, LimitOrder, StopOrder, StopLimitOrder
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            StopOrder(uuid4().hex, OrderOperation.SELL, pair, pair_info, Decimal("1004"), Decimal("35000")),
            (Decimal("40001.76"), Decimal("50401.01"), Decimal("30000"), Decimal("45157.09"), Decimal("1000.3")),
            {},
        ),
    ],
...
@pytest.mark.parametrize(
    "order",
    [
        LimitOrder(uuid4().hex, OrderOperation.SELL, pair, pair_info, Decimal("1"), Decimal("39000.01")),
        LimitOrder(uuid4().hex, OrderOperation.BUY, pair, pair_info, Decimal("1"), Decimal("49000.01")),
        StopLimitOrder(
            uuid4().hex, OrderOperation.SELL, pair, pair_info, Decimal("1"), Decimal("39000.01"), Decimal("39000.01")
        ),
    ],
)
