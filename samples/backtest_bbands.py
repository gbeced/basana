...
async def main():
    ...
    lending_strategy = lending.MarginLoans(
        ...
        default_conditions=lending.MarginLoanConditions(
            interest_symbol=pair.quote_symbol,
            interest_percentage=Decimal("7"),
    ...
    position_mgr = position_manager.PositionManager(exchange, position_amount, pair.quote_symbol, stop_loss_pct)
